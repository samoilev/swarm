        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                LazyVStack(alignment: .leading, spacing: 22) {
                    helpSection(
                        L10n.tr("Первые шаги"),
                        L10n.tr("Создайте дерево или импортируйте GEDCOM. В карточке нажмите «Сохранить». Остальные изменения сохраняются автоматически.")
                    )
                    helpSection(
                        L10n.tr("Даты"),
                        L10n.tr("Введите дату, месяц и год или только год: 05.03.1978, 03.1978, 1978. Для неточных дат выберите «Около», «До» или «После».")
                    )
                    helpSection(
                        L10n.tr("Родство"),
                    ...
                    helpSection(
                        L10n.tr("Виды дерева"),
                        L10n.tr("Дерево, список людей, хронология, места, проверка, веер предков и карта показывают данные одного дерева.")
                    )
                    helpSection(
                        L10n.tr("Клавиатура"),
                    ...
                    helpSection(
                        ...
                        L10n.tr("Поиск мест и офлайн-карта работают на этом Mac: индекс GeoNames (бывший СССР, Европа, Северная Америка) и векторы Natural Earth. Координаты сохраняются в файле GEDCOM. Apple Maps видит только, какой участок карты открыт.")
                    )
                    helpSection(
                        L10n.tr("Восстановление"),
                        L10n.tr("Предыдущие версии доступны по кнопке «Сохранено» и в меню дерева. Хранятся последние 50 версий без фотографий и вложений. В разделе «Восстановление» доступны удалённые файлы за 30 дней, резервные копии и архивированные деревья.")
                    )
                    helpSection(
                        L10n.tr("Поддержка"),
