            ...
            ScrollView {
                LazyVStack(alignment: .leading, spacing: 22) {
                    ...
                    helpSection(
                        ...
                        L10n.tr("Предыдущие версии — по часам «Сохранено» в дереве или из меню его карточки: 50 последних сохранений, возврат с подтверждением. Меню архива → восстановление хранит удалённые файлы 30 дней и полные копии архива.")
                    )
                    helpSection(
                        L10n.tr("Поддержка"),
