    ...
    var body: some View {
        Form {
            ...
            Section(L10n.tr("Карта и конфиденциальность")) {
                ...
                Text(L10n.tr("FamilyTreeStudio не передаёт Apple имена людей, события, заметки или подписи маркеров. Для Apple Maps передаётся только необходимая самому системному картографическому сервису область просмотра. Переключитесь на офлайн-карту, если не хотите и этого."))
                    .font(.caption)
                    .foregroundColor(.secondary)
            }
